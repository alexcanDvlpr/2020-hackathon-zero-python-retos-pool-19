...
def mayus(update, context):
    ...
    # update.message.reply_text(palabra.upper())
    return update.message.reply_text(palabra.upper())
...
def main():
    ...
    updater = Updater("938550437:AAE1ZoaBGd9rwn4PTM_FvD8oCrLoVAtjphg", use_context=True)
